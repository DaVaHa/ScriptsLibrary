...
write.csv( full_df[, c("id","sales")], paste(path_to_dir, "trail_1_tbats.csv", sep=""), row.names=FALSE)

# check
# write.csv( full_df, paste(path_to_dir, "trail_1_tbats.csv", sep=""), row.names=FALSE)
